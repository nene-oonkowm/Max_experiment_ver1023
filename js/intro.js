  ...
  pages: [
    ...
    `<div style="text-align:left; max-width:900px; margin:auto; line-height:1.8;">
      ...
      <ul>
        ...
        <li>本実験は参加者の皆さんと同時に進めていきます。<br>実験中は<b>お席を離れないでください。3分以上画面操作がない場合は、システムが自動終了します。</b></li>
      ...
      <ul>
        ...
        <li>質問・トラブルはZoomウェビナーのQ&A機能で、実験スタッフにお知らせください。<br>(<span style = color:red;>画面の更新・再読み込みはしないでください</span>)</li>
    ...
    `<div style="text-align:left; max-width:950px; margin:auto; line-height:1.8;">
      ...
      <br>参加者同士が行動をお互いに見ることはなく、あなたのIDなどが他の参加者に知られることはありません。</p>
    ...
    `<div style="text-align:left; max-width:950px; margin:auto; line-height:1.8;">
      <h2>報酬について</h2>
      <p>実験終了後にお渡しする報酬金額は、以下の3つの合計になります。</p>
      <ol>
        <li><span style="font-size: 1.3em;"><b>参加報酬</b></span> (100円) : Zoomウェビナーによるインストラクションへの参加で支払われます。</li>
        <li><span style="font-size: 1.3em;"><b>ゲーム報酬</b></span> (<b style = color:red;>0~1000円</b>) : あなたが実験中に獲得したカードの金額がそのままゲーム報酬となります。</li>
    ...
    `<div style="text-align:left; max-width:750px; margin:auto; line-height:1.8;">
      ...
      <p>あなたがすでに1度めくったカードも、もし他の参加者に獲得されていなければ、もう1度選ぶことができます。</p>
    ...
    `<div style="text-align:left; max-width:750px; max-height:500px; margin:auto; line-height:1.8; align-items: flex-start;">
      ...
      <img src="img/intro5.png" alt="" style="width:400px; display:block; margin:16px auto;">
    </div>`,

    // Intro11 実験説明６（確認）
    `<div style="text-align:left; max-width:750px; margin:auto; line-height:1.8;">
      <p>以上で実験についての説明は終わりです。分からないところがありましたら、<br>「戻る」ボタンをクリックして前のページに戻り、もう一度説明を読み直してください。</p>
      <p>また、説明を読んでも分からないところがありましたら、ZoomウェビナーのQ&A機能で実験スタッフにお知らせください。<br></p>
