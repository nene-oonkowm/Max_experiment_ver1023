...
const confirmTestQ2Feedback = {
  ...
  stimulus: function() {
    ...
    if (last === "✕") {
      return `<p style="line-height:1.8;"><b>正解です！</b><br>金額が表示されるのは選択した本人のみです。<br>あなたが選択したカードに書かれた金額はあなたしか見ることが出来ません。<br>また、他の参加者がめくったカードをあなたが見ることは出来ません。</p>`;
    } else {
      return `<p style="line-height:1.8;"><b>不正解です。</b><br>金額が表示されるのは選択した本人のみです。<br>あなたが選択したカードに書かれた金額はあなたしか見ることが出来ません。<br>また、他の参加者がめくったカードをあなたが見ることは出来ません。</p>`;
    }
  },
  choices: ["次へ"]
};
